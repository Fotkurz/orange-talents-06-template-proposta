...
public class ProposalRepositoryTest {
    ...
    @Test
    @DisplayName("deveRetornarPropostasQueSaoElegiveisMasNaoTemCartaoAssociado")
    public void test01 () {
        List<Proposal> lista = proposalRepository.findAllCardIdIsNull();

        Assert.assertNotNull(lista);
        Assert.assertEquals(3, lista.size());
        Assert.assertEquals("574.745.510-98", lista.get(0).getDocument());
    }
